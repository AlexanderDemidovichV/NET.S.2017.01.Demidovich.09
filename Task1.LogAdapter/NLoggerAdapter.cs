...
namespace Task1.LogAdapter
{
    public class NLoggerAdapter: ILogger
    {
        ...
        public void Trace(string message, Exception exception, params object[] args) => logger.Trace(exception, message, args);

        public void Trace(string message, params object[] args) => logger.Trace(message, args);

        public void Debug(string message) => logger.Debug(message);

        public void Debug(string message, Exception exception, params object[] args) => logger.Debug(exception, message, args);

        public void Debug(string message, params object[] args) => logger.Debug(message, args);

        public void Info(string message) => logger.Info(message);

        public void Info(string message, Exception exception, params object[] args) => logger.Info(exception, message, args);

        public void Info(string message, params object[] args) => logger.Info(message, args);

        public void Warn(string message) => logger.Warn(message);

        public void Warn(string message, Exception exception, params object[] args) => logger.Warn(exception, message, args);

        public void Warn(string message, params object[] args) => logger.Warn(message, args);

        public void Error(string message) => logger.Error(message);

        public void Error(string message, Exception exception, params object[] args) => logger.Error(exception, message, args);

        public void Error(string message, params object[] args) => logger.Error(message, args);

        public void Fatal(string message) => logger.Fatal(message);

        public void Fatal(string message, Exception exception, params object[] args) => logger.Fatal(exception, message, args);
